...
export async function routeRuntimeWarning(params: {
  ...
  return {
    policy,
    routeResult,
    suppressUserChat: policy.userChat === "never" && isSuccessfulWarningRoute(routeResult),
  };
}
