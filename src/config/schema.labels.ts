...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "messages.toolWarnings.enabled": "Tool Warning Routing Enabled",
  "messages.toolWarnings.target": "Tool Warning Target Channel",
  "messages.toolWarnings.to": "Tool Warning Target ID",
  "messages.toolWarnings.execOnly": "Route Only Exec/Bash Warnings",
  "messages.toolWarnings.fallbackToUserChat": "Tool Warning Fallback to User Chat",
  "messages.toolWarnings.dedupeWindowMs": "Tool Warning Dedupe Window (ms)",
